                       ...
                       accessibilityLabel:(NSString*)accessibilityLabel
{
    ...
    customButton.normalTintColor = [UIColor grayColor];
    customButton.selectedTintColor = [UIColor darkGrayColor];
    customButton.disabledTintColor = [UIColor lightGrayColor];
