...
- (void)commonSetup
{
    ...
    _defaultFont = [UIFont fontWithName:@"IowanOldStyle-Roman" size:33.0];
    _boldFont = [UIFont fontWithName:@"IowanOldStyle-Bold" size:33.0];
    _italicFont = [UIFont fontWithName:@"IowanOldStyle-Italic" size:33.0];
